...
void main() => runApp(new MaterialApp(
      home: new L3thalStats(),
    ));

class L3thalStats extends StatefulWidget {
  @override
  FourthScreenState createState() => new FourthScreenState();
}

class FourthScreenState extends State<L3thalStats> {

  final String url="http://api.steampowered.com/ISteamUserStats/GetUserStatsForGame/v0002/?appid=730&key=API_KEY&steamid=76561198383383121&format=json";
  List data;
