import 'package:csgoapp/players/challaak/challaakstats.dart';
...
void main() => runApp(new MaterialApp(
      home: new ChallaakPage(),
  ),
      
    );

class ChallaakPage extends StatefulWidget {
  @override
  HomePageState createState() => new HomePageState();
}

class HomePageState extends State<ChallaakPage> {

  final String url="http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=API_KEY&steamids=76561198864154521&format=json";
  List data;
...
_launchUrl2() async {
  final String url = "https://steamcommunity.com/profiles/76561198864154521/";
