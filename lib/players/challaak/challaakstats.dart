...
void main() => runApp(new MaterialApp(
      home: new ChallaakStats(),
    ));

class ChallaakStats extends StatefulWidget {
  @override
  FourthScreenState createState() => new FourthScreenState();
}

class FourthScreenState extends State<ChallaakStats> {

  final String url="http://api.steampowered.com/ISteamUserStats/GetUserStatsForGame/v0002/?appid=730&key=API_KEY&steamid=76561198864154521&format=json";
  List data;
